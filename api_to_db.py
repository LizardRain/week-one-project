...
location_df = pd.DataFrame.from_records(location_dict, exclude=['bugsnax', 'inhabitants'])
grumpus_df = pd.DataFrame.from_records(grumpus_dict, exclude=['fears', 'hates', 'locations', 'loves'])
